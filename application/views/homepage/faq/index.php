	...
	<div class="container">
		<div class="row">
			<div class="col-lg-4">
				...
				<p><a href="mailto:admin@gmail.com?Subject=Legal%Issues">legal@mail.com</a></p>
				<address>
					Airspace, Inc. <br>
			...
			<div class="col-lg-8 mt-5 mt-lg-0">
				<div class="pl-0 pl-lg-4">
					<h2 class="mb-3">Welcome to Airspace!</h2>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia ullam sint quas pariatur ipsam nemo
						...
						obcaecati maiores voluptates.</p>
					<h4>1.Overview</h4>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas iusto, alias, tempora fuga quam eveniet
						neque excepturi aliquid. Eligendi, mollitia.</p>
					<h4>2. Data We Collect</h4>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias, earum, quibusdam? Accusantium, eaque at
						...
						impedit suscipit quidem optio asperiores quibusdam. Minus, vel.</p>
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellendus repellat id, laboriosam ipsa
						...
						libero laudantium corporis, delectus impedit sunt.</p>
					<h4>4. How We Disclose Data.</h4>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tenetur itaque ut culpa totam ratione! Iste
						...
						magnam, vero itaque!</p>
					<h4>5. Security</h4>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae blanditiis quod saepe, inventore ipsum sint
						cum iste quae ratione nobis laborum minima autem totam similique, quia neque deleniti! Provident, suscipit.
					</p>
					<h4>6. Advertising.</h4>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus, eaque repellendus placeat aperiam fugit.
